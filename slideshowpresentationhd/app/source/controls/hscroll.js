   ...
   */
   ...
   animate: function() {
      ...
      var fn = enyo.bind(this, function() {
         ...
         /*if (this.isInOverScroll() && this.autoMode == true) {
            if (this.rightBoundary > -100000) {
               this.REALRIGHTBOUNDARY = this.rightBoundary
            }
   ...
   /*autoMode: false,
   REALRIGHTBOUNDARY: -444,
   setAutoMode: function() {
      this.autoMode = true
   },
   getRealRightBoundry: function() {
      return this.REALRIGHTBOUNDARY;
   },*/
   //* @protected
   ...
   getScrollPosition: function(inPosition) {
      return this.x;
   },
   ...
   isInOverScroll: function() {
      //this.log(this.x + "," +  this.rightBoundary)
...
enyo.kind({
   ...
   acceleratedChanged: function() {
      ...
      this.$.content.applyStyle("margin", this.accelerated ? null : "900 0px");
...
enyo.kind({
   ...
   */
   ...
   setAccelerated: function(b) {
       this.$.scroller.setAccelerated(b)
   }
});