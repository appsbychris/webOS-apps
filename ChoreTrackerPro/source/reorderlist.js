               ...
               //during autoscroll
                  ...
                  if(!this.dragpulseJob){
                     ...
                     if (e.pageY < this.contentOffsetTop + 20 || e.pageY > this.contentOffsetBottom - 20) {
                        ...
                        this.dragpulseJob = setInterval(enyo.bind(this, "autoScroll"), 40); // start the timer for autoscroll. 50ms = 20fps
                     }
                  }else{
                     ...
                     else if (e.pageY < this.contentOffsetTop + 20 || e.pageY > this.contentOffsetBottom - 20) {
...
//                  this.log("drop",this.lastIndex,e.dragInfo)
   ...
   setAccelerated: function(b) {
      ...
      enyo.error ("SET :" + this.$.scroller.getAccelerated())
   }
});